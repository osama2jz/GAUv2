...
const Donations = () => {
  ...
  const form = useForm({
    ...
    validate: {
      firstName: (value) =>
        value?.length < 1 ? translate("Enter First Name") : null,
      lastName: (value) =>
        value?.length < 1 ? translate("Enter Last Name") : null,
      email: (value) =>
        /^\S+@\S+$/.test(value) ? null : translate("Enter valid email"),
      phoneNo: (value) =>
        value?.length < 1 ? translate("Enter Phone Number") : null,
